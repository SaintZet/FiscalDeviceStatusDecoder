    ...
    public Dictionary<(int, int), string> Document2 = new()
            {
                ...
                { (1,6), "# Изпълнението на командата не е позволено в текущия фискален режим" },
                { (1,7), "При изпълнение на командата се е получило препълване на някои полета от сумите. Статус 1.1 също ще се установи и командата няма да предизвика промяна на данните в принтера" },
                ...
                { (2,7), "# Свършила е хартията. Ако се вдигне този флаг по време на команда, свързана с печат, токомандата е отхвърлена и не е променила състоянието на принтера" },
